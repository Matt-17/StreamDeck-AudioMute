...
Download the `de.codeix.audiotoggle.streamDeckPlugin` file from [the releases page](https://github.com/Matt-17/StreamDeck-AudioMute/releases), and double-click it.
